...
<div class="about-form">
    ...
    <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
            ...
            <?= $form->field($model, 'part_text_uz')->textInput(['maxlength' => true]) ?>
            <?= $form->field($model, 'main_text_uz')->widget(Summernote::className())?>
        </div>
        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
            <?= $form->field($model, 'head_text_ru')->textInput(['maxlength' => true]) ?>
            <?= $form->field($model, 'part_text_ru')->textInput(['maxlength' => true]) ?>
            <?= $form->field($model, 'main_text_ru')->widget(Summernote::className())?>
        </div>
        <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
            <?= $form->field($model, 'head_text_en')->textInput(['maxlength' => true]) ?>
            <?= $form->field($model, 'part_text_en')->textInput(['maxlength' => true]) ?>
            <?= $form->field($model, 'main_text_en')->widget(Summernote::className())?> 
                   </div>
