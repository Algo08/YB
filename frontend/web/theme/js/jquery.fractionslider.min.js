...
(function (e) {
    ...
    var r = function (t, n) {
        ...
        function T(t) {
            e.isFunction(t) &&
                t.call(this, f, r.currentSlide, r.lastSlide, r.currentStep);
        }
        function N(t) {
        ...
        function A() {
            ...
            if (r.init) {
                ...
                s.push(
                    setTimeout(function () {
                        if (r.maxSlide == 0 && r.running == true) {
                        } else {
                            r.lastSlide = r.currentSlide;
                            r.currentSlide += 1;
                            O();
        ...
        function O(e) {
            ...
            i.currentSlide = f
                .children(".slide:eq(" + r.currentSlide + ")")
                .addClass("active-slide");
            if (i.currentSlide.length == 0) {
                r.currentSlide = 0;
                i.currentSlide = f.children(
                    ".slide:eq(" + r.currentSlide + ")"
                );
            }
            if (r.lastSlide != null) {
                if (r.lastSlide < 0) {
        ...
        function B() {
            ...
            if (r.currentStep == 0) {
                ...
                e = i.currentSlide.children(
                    '*[data-step="' + r.currentStep + '"]:not([data-fixed])'
                );
            }
            r.maxObjs = e.length;
            o = e;
        ...
        function V() {
            ...
            s.each(function () {
                ...
                if (t.attr("width") != null && t.attr("width") != "") {
                    ...
                    t.prop("tagName").toLowerCase() == "img" &&
                    i != -1
                ) {
                    s = J(t);
                    n = Y(s, u);
            ...
            f.css({ width: "auto", height: "auto" }).append(
        ...
        var r = {
            ...
            i = { currentSlide: null, lastSlide: null, animationkey: "none" },
            s = [],
            o = null,
            u = null,
            a = null;
