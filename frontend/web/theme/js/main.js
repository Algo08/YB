    ...
    $(document).ready(function () {
        ...
        function hasScrolled() {
            ...
            if (st > lastScrollTop && st > navbarHeight) {
                // Scroll Down
                $(".header-inner")
                    .removeClass("header-scroll-fixed")
